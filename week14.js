...
const myFirstArray = ['Рокки', 6, true];
...
const myInformation = ['Елизавета', 1, 'февраля', 'водолей'];
...
const num = numbers.map(function(numbers){
...
let otherRussianCities = ['Санкт-Петербург', 'Москва', 'Екатеринбург'];
let russianCities = [...otherRussianCities, 'Казань', 'Нижний Новгород'];
